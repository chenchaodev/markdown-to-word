...
| mermaid.md | Mermaid 渲染 core 层契约测试(批次 10 功能 1,8c):(场景:main) | test/segments/mermaid.test.js |
| mermaid-special.md | Mermaid 渲染 core 层契约测试(批次 10 功能 1,8c):(场景:special) | test/segments/mermaid.test.js |
...
| raw-html-cross.md | 内联格式白名单测试(原 make-batch4-sample.mjs 段 6):(场景:cross) | test/segments/raw-html.test.js |
| raw-html.md | 内联格式白名单测试(原 make-batch4-sample.mjs 段 6):(场景:main) | test/segments/raw-html.test.js |
