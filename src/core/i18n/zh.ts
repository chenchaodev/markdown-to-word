...
const dict = {
  ...
  /* ---------- 通用 ---------- */
    ...
    "common.revealFailed": "无法打开文件夹:${error}",
    ...
    "wizard.stepCover": "封面",
    "wizard.stepHeader": "页眉页脚",
    "wizard.stepWatermark": "水印",
    "wizard.stepMerge": "合并源",
    "wizard.stepToc": "目录",
    "wizard.stepOutput": "付印",
    "wizard.template.label": "模板预设",
    "wizard.template.import": "导入 Word 模板…",
    "wizard.template.hint": "选择模板将覆盖排版与页面设置;也可从 Word 文档导入样式与页面尺寸。",
    "wizard.cover.fieldTitle": "书名 / 标题",
    "wizard.cover.fieldAuthor": "作者",
    "wizard.cover.fieldDate": "日期",
    "wizard.cover.fromFrontmatter": "已按首个源文件 frontmatter 预填,可修改。",
    "wizard.cover.preview": "封面预览",
    "wizard.cover.missingTitle": "未填写标题,将不生成封面页。",
    "wizard.merge.add": "添加文件…",
    "wizard.merge.empty": "至少选择 2 个文件才能合并成书。",
    "wizard.merge.hint": "列表顺序即合并顺序,可用 ↑/↓ 调整。",
    "wizard.merge.up": "上移",
    "wizard.merge.down": "下移",
    "wizard.toc.enable": "自动目录",
    "wizard.toc.mode": "目录模式",
    "wizard.toc.modeStatic": "静态目录(免更新)",
    "wizard.toc.modeField": "Word 域目录(带页码)",
    "wizard.output.format": "付印格式",
