...
const dict = {
    ...
    "settings.groupWatermark": "Text watermark",
    ...
    "settings.presetScopeNote": "Presets cover the Page, Text, and Numbering & TOC groups; header/footer and output are not included.",
