...
contextBridge.exposeInMainWorld("api", {
  ...
  convert: (filePath: string, format: "docx" | "pdf") => ipcRenderer.invoke(CH.convertSingle, filePath, format),
  ...
  revealInFolder: (filePath: string): Promise<void> => ipcRenderer.invoke(CH.shellRevealInFolder, filePath),
