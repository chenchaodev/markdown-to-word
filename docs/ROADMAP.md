...
- [ ] **8c Mermaid 渲染导出**(中;无依赖)——PDF 近白送(Chromium 有 DOM,隐藏窗口渲染),docx 嵌入 SVG/PNG;原「砍」理由「无 DOM 环境」在 Electron 内不成立(批次 8 已重新评估升回);差异化亮点,建议起手;**调研完成(2026-08-13,方案见 RESEARCH.md 条目 + archive 20260813-193532),实现进行中**;**调研完成(2026-08-13,方案见 RESEARCH.md 条目 + archive 20260813-193532),实现进行中**;**调研完成(2026-08-13,方案见 RESEARCH.md 条目 + archive 20260813-193532),实现进行中**;**调研完成(2026-08-13,方案见 RESEARCH.md 条目 + archive 20260813-193532),实现进行中**;**调研完成(2026-08-13,方案见 RESEARCH.md 条目 + archive 20260813-193532),实现进行中**;**调研完成(2026-08-13,方案见 RESEARCH.md 条目 + archive 20260813-193532),实现进行中**
- [ ] **题注/章节交叉引用**(中;依赖 8b 补 label 机制)——承接批次 8/9 决策链(D1-D4 免更新路线,静态注入编号 + 超链接跳转);学术正式化闭环,建议起手
