...
### 批次 8「功能扩展:学术正式化延伸」(2026-08-08 11:50:33 规划,来源:lib-1 竞品调研;勘察 exp-1 + 域 API 调研 lib-1/lib-3 已完成,落盘 docs/RESEARCH.md)🔄 **进行中(2026-08-09 开工)**
...
- 当前迭代:8a + 8b(同一编号体系主题);8c/8d 排下一迭代
- 验收清单:docs/ACCEPTANCE.md 批次 8 节
按价值/成本排序,起手 3-4 项:
