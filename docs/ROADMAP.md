...
- 批次 7「体验优化 + 流程简化」✅ 0.17.0 + 0.17.1(3 个实测 bug 修复),**待用户 GUI 实测**(清单 docs/ACCEPTANCE.md)

### 批次 8「功能扩展:学术正式化延伸」(2026-08-08 11:50:33 规划,来源:lib-1 竞品调研;勘察 exp-1 + 域 API 调研 lib-1/lib-3 已完成,落盘 docs/RESEARCH.md)🔄 **调研完成,暂停待用户决策**
按价值/成本排序,起手 3-4 项:
