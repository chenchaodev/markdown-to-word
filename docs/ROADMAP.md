...
- [ ] **模板导入**(中高;无依赖,先导出侧)——用户上传 docx/CSS 作为样式模板;原「延后」项,排在功能候选后段;**2026-08-14 拆解:批次 13 实施「预设 JSON 导入/导出」(首选,复用 sanitize 校验);CSS 覆盖 pdf 路线次选;docx 模板导入暂缓(docx4js 停维护 + OOXML 样式逆映射工程量大,方案对比见 archive/20260814-201622)**
