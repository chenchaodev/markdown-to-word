...
> **命名规约(2026-08-24 起)**:新存档文件名遵守 `YYYY-MM-DD-HHmmss-主题.md`(禁冒号);历史 24 份存档**不改名**(避免断链既有互引),仅自本日起对新存档执行。

| 存档(archive/) | 主题 |
|---|---|
| `2026-08-24-134811-全库审计总报告.md` | 全库审计(五路子审计+总报告+61 项待办清单,同前缀子报告 5 份) |
| `2026-08-24-193838-审计整改裁决与不做项.md` | 审计整改裁决记录(DECIDE-1/ENG-3 用户裁决 + 不做/仅记录项 + CORE-9 勘误) |
...
| `2026-08-25-182036-功能候选调研与迭代排期.md` | 2.0.0 后功能开发调研(竞品对标+能力盘点+9 项拍板+F1-F9 批次安排) |
