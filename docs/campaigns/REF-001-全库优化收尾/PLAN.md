...
> #03 把 `../../STATUS.md` 的日期流水按四路分流拆尽时,下列**库/框架实测事实**原只在流水行里、`../../RESEARCH.md` 尚无对应条目;本批对 `RESEARCH.md` 的写权限仅限那一处断链,故先在此留证,由 #14 升格为正式条目(**条目不删,只补**)。相关提交:`56cf595`、`504870a`、`f89dbc5`。
