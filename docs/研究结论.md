...
### 2026-08-08 功能扩展调研要点(@librarian,批次 8 规划依据,详见路线图)
...
### 2026-08-08 易用性调研要点(@librarian,批次 7 已实施;未做项见路线图)
...
### 2026-08-06 批次 6 公式链路实现结论(@librarian 调研 + 实测,勿回退)
...
### 2026-08-05 批次 5 docx 标题编号 + 内部链接实现结论(已验证,勿回退)
...
### 2026-08-05 批次 4 docx 页眉页脚 + 页码实现结论(已验证,勿回退)
...
### 2026-08-05 批次 4 书签实现结论 + 「点击不跳转」修复(已验证,勿回退)
...
### 2026-08-04 批次 3 实现结论(批量/合并,已验证)
...
### 2026-08-03 批次 2 spike 与实测结论(已验证,勿回退)
...
### 2026-08-03 批次 1 实测事实(docx/pdf 排版控制,已验证,勿回退)
...
### 2026-08-02 G5 打包坑 + 实测事实(electron-builder,已验证,勿回退)
...
### 2026-08-02 G4 实测事实(printToPDF 管线,已验证,勿回退)
