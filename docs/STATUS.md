...
- 2026-08-24:**全库审计整改 P0~P5 + i18n 字典拆分完成,待人工 GUI 实测与分批提交**(五车道并行实施:工程化CI/core 单源化重构/main+renderer 重构加固/测试体系/文档同步债;61 项审计待办约 54 项实施、7 项不做/仅记录见 archive/2026-08-24-193838-审计整改裁决与不做项.md;DECIDE-1 统一 Word 口径「1」;测试 45→51 段全绿含恒等守护段;新增能力:image-downloader 私网拦截+大小上限/shell 白名单/M2W_ONLY 单段筛选/i18n 注册表化+ja/ko/fr/ru 渐进翻译;待实测清单见 ACCEPTANCE.md 本批次节)
...
## 打开事项
- [ ] 审计整改 P0~P5 + i18n 字典拆分:待人工 GUI 实测(清单见 ACCEPTANCE.md「审计整改批次」节)与分批提交
