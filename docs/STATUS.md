...
## 打开事项
- [x] 功能候选(批次 10 全部完成:8c Mermaid 0.23.0 / 交叉引用 0.24.0 / 模板导入 0.27.0+0.29.0 / 公式编号开关 0.29.0 / 批注 0.31.0 / WPS 兼容矩阵 0.31.0);剩余唯一未做项「代码块语法高亮写 docx」见 ROADMAP「当前待办」;暂缓/延后/砍项见 `docs/ROADMAP.md`「当前待办」节
