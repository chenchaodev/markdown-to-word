- 2026-08-24:**GUI 实测全部通过+目录重组批⑥补遗完成,准备发版 1.2.0**(用户确认 B9 十项/B13 五项/重组回归四项全过;批⑥ main 根级归组补遗 9909d74:ipc/persist/services 域归组,方案漏排经用户指出补齐,纯移动 GUI 无感);ACCEPTANCE 三节全勾;下一步版本三统一发版 1.2.0
