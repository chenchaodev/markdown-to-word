- 2026-08-14:**批次 13「模板导入(预设 JSON 导入/导出)」进行中**(方案存档 archive/20260814-201622):lib-1 五方案对比拍板首选 JSON 导入/导出(复用 sanitize 校验,零新依赖);CSS 覆盖 pdf 次选、docx 模板导入暂缓记 ROADMAP;待实测见 ACCEPTANCE.md 批次 13 T1-T3
