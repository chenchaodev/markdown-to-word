...
- 2026-08-14:**批次 12「界面体验优化」Phase 0+1 实现完成,待用户 GUI 实测**(方案存档 archive/20260814-185113):Phase 0 速赢 7 项拆 4 提交(af572e4 U1 点击行为对齐/740dd5d U2 窗口最小尺寸+密度上限/22cd5ab U3 快捷键提示+文案统一/dfd9a40 U4 预设上限提示);Phase 1 三项一次提交(C2 底部操作区 sticky 常驻/C10 双击预览可见提示+删 selected 死代码/C9 弹窗焦点陷阱);typecheck/build/31 段/smoke 全绿;待实测见 ACCEPTANCE.md 批次 12 U1-U4;Phase 2(C8 模板预设上移/C12 最近条目加载入口)待续;方向 B(质量与测试)方案存档备查
