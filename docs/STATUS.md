...
## 打开事项
- [ ] **批次 8「学术正式化延伸」暂停中,等用户拍板后再开工**(规划见路线图批次 8,调研已落盘):开工前需拍板 **D1 编号路线**(更新域路线 vs 免更新路线,8a/8b 必须同路线)+ **D2 题注语法**(倾向前缀行「图: 标题」);首起 8a TOC 域开关化 + 8b 图/表题注自动编号,后续 8c Mermaid、8d 公式编号
