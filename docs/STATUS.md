- 2026-08-23:**发版 1.0.1 完成**(审计改进第一批:B1 安全加固/B2 健壮性/B3 数据渲染正确性/B10 工程基建/B14 文档修正,约 40 项;版本号三统一 package.json=tag v1.0.1=CHANGELOG [1.0.1];Release 由 tag 推送触发 release.yml 自动发布)
