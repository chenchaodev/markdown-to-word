...
- 2026-08-14:**批次 12「界面体验优化」进行中**(方向 A 已选,方案存档 archive/20260814-185113):@designer 评审出 20 项 UX 问题(P1-P20)+ 12 项候选(C1-C12)三阶段;本批实施 **Phase 0 速赢 7 项**(C11 文案统一/C4 快捷键可见化/C1 点击行为对齐/C5 状态行完整信息/C6 预设上限反馈/C7 单文件态压缩/C3 窗口最小尺寸+密度上限),拆 4 验收单元(U1-U4)见 ACCEPTANCE.md;方向 B(代码质量与测试)方案已出存档备查
