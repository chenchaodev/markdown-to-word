...
## 当前状态
- 2026-08-09:**批次 8「学术正式化延伸」进行中**(8a TOC 静态目录 + 8b 图/表题注编号;D1=免更新路线、D2=前缀行识别已拍板;规划见路线图批次 8,清单见 docs/ACCEPTANCE.md)
...
## 打开事项
- [ ] **批次 8 进行中**(2026-08-09 开工):8a TOC 开关化 + 免更新静态目录(beginDirty:false + cachedEntries)、8b 题注前缀行识别 + 静态编号,已拍板 D1=免更新路线 / D2=前缀行识别;后续 8c Mermaid、8d 公式编号排下一迭代
- [ ] 批次 8 之后候选:代码块语法高亮写 docx、模板导入(先导出侧)、批注、WPS 兼容矩阵