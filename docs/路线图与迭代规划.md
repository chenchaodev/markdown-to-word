...
> 2026-08-02 制定,同日因需求变更(GUI)修订;2026-08-02 晚二期规划经 @oracle 评审重排。迭代完成记录见 `docs/CHANGELOG.md`;选型结论见 `docs/架构决策.md`(ADR-001/002);调研证据见 `docs/研究结论.md` 与 `docs/archive/` 存档。
...
## 二期规划(2026-08-02 @oracle 评审后定稿;优先 P1→P0 页面设置、PDF 书签 P1→P2 先 spike)
...
### 批次 8「功能扩展:学术正式化延伸」(2026-08-08 规划,来源:lib-1 竞品调研;勘察 exp-1 + 域 API 调研 lib-1/lib-3 已完成,落盘 docs/研究结论.md)🔄 **调研完成,暂停待用户决策**
按价值/成本排序,起手 3-4 项:
...
- 砍:Mermaid(原因无 DOM,批次 8 已重新评估升回)、CLI 转正(已有 cli/index.ts 调试通道)、自动更新/签名(本地离线隐私卖点,更新反噬)、i18n、目录监视/同步、PDF 多栏、批量重命名
